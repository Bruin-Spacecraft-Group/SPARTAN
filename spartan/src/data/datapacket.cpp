...
void spartan::IMUDataPacket::populate(DataPacket &dp) {
...
void spartan::AltimeterDataPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
    m_pressure = dp.pressure;
    m_baro_altitude = dp.baro_altitude;
}

void spartan::GPSDataPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
...
void spartan::AVNHealthPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
...
void spartan::FCHealthPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
    m_FC_voltage = dp.FC_voltage;
    m_FC_current = dp.FC_current;
}

void spartan::RadioHealthPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
    m_radio_voltage = dp.radio_voltage;
    m_radio_current = dp.radio_current;
}

void spartan::PayloadHealthPacket::populate(DataPacket &dp) {
    m_timestamp = dp.timestamp;
